...
### Općeniti primjer ML pristupa na "pravim" podatcima
...
### Osnovni primjer predikcijskog modela
...
Ovo je također jedna od vrlo popularnih metoda nenadgledanog strojnog učenja koja prepoznaje strukturu u podatcima na način da organizira podatke u interno koherentne klastere, a eksterno heterogene klastere. Drugačije rečeno, opservacije unutar klastera trebaju biti jako slične, a opservacije između klastera jako različite.
...
##  $ Survived: int  0 1 0 1 0 0 1 1 0 1 ...
##  $ Pclass  : int  3 2 1 3 3 3 3 3 3 1 ...
##  $ Sex     : chr  "male" "female" "male" "male" ...
##  $ Age     : num  38 34 24 3 19 2 4 18 17 47 ...
```
...
##  $ Survived: int  1 1 0 1 1 0 0 1 1 0 ...
##  $ Pclass  : int  3 2 1 1 1 3 2 1 2 1 ...
##  $ Sex     : chr  "female" "female" "male" "female" ...
##  $ Age     : num  16 45 64 21 60 33 66 35 32 36 ...
```
