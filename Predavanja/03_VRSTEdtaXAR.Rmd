...
#### Primjer strukturiranih podataka [Maddison](https://www.rug.nl/ggdc/historicaldevelopment/maddison/releases/maddison-project-database-2020?lang=en)
...
#### Primjer nestrukturiranih podataka [Wikipedia](https://en.wikipedia.org/wiki/Houston)
...
- SQL, Excel
<br>
- podatkovni polimorfizam zbog uspona novih tehnologije (web,mobile, socialNet,IoT, programming)
<br>
